      ...
      <div className="relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2">
        ...
        >
          <div className="w-full lg:pr-24 mx-auto max-w-[48rem]">
            {/* typing text */}
            <motion.div
              className="mb-3 text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold text-white tracking-wide min-h-[1.6em] whitespace-nowrap"
            ...
            >
              I build modern web experiences and practical AI solutions that
              turn ideas into useful, scalable, and impactful digital products.
            </motion.p>
